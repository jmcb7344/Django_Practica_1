...
class Materia(models.Model):
    nombre = models.CharField(max_length=25, verbose_name='Nombre del curso')
    descripcion = models.TextField(null=True, blank=True, verbose_name='Descripcion del curso')
